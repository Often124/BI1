  ...
  if (!weather) {
    return (
      <div className="flex items-center gap-2 text-white/50">
        <span className="text-base">Chargement météo...</span>
      </div>
    );
  }
    ...
    <div className="flex flex-col items-end gap-1">
      <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-sm text-white/70 capitalize leading-tight">
      ...
      {weather.forecast && weather.forecast.length > 0 && (
        <div className="flex items-center gap-2">
          {weather.forecast.map((forecastDay) => (
            <div key={forecastDay.day} className="flex items-center gap-1 rounded-md bg-white/5 px-2 py-1.5">
              <span className="text-xs font-semibold text-white/80">{forecastDay.day}</span>
              <img
